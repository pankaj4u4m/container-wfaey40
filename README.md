...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wfaey40.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wfaey40.containers.anotherwebservice.com/
...
```
git clone git@github.com:pankaj4u4m/container-wfaey40.git
cd container-wfaey40
```
...
```
docker attach container-wfaey40
```
